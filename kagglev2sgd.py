...
Original file is located at
    https://colab.research.google.com/drive/1JTFH4KZMS8z9UfZlXh6JF275nKaQAjB3
"""
...
history = model.fit(train1, y_train, epochs=1000)
...
df.to_csv (r'haiqzhu2.csv', index = False, header=True)
